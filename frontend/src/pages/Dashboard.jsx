        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <BeeLogo width={56} height={56} />
              <div>
                <h1 className="honey-text-strong text-2xl">HiveFive</h1>
                <p className="honey-text-subtle text-sm">Welcome back, {user?.name || user?.email}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button
